...
export const adminList = [
    {mobile:8682890117, auth:"SUPER_ADMIN_ACCESS"},{mobile:9994374553, auth:"SUPER_ADMIN_ACCESS"},
    {mobile:9944419808, auth:"SUPER_ADMIN_ACCESS"}, {mobile:9790656890, auth:"ADMIN_ACCESS"}, 
    {mobile:9965388040, auth:"ADMIN_ACCESS"}, {mobile:9842702602, auth:"ADMIN_ACCESS"}]

export const DB = {
    players : "player-demo-2024"
}
...
export const PAYMENT_STATUS = ["PAYMENT_VERIFIED", "PAYMENT_NOT_VERIFIED", "NOT_PAID", "NMS", "SHIVA", "RAVI", "WAITING", "DUPLICATE", "CASH"]
